# Infant Respiratory Mechanics Reference Values

**Extracted:** 2026-01-15
**Purpose:** Human reference model for ventilation fidelity - MST paper Section 2.3

---

## Source 1: Huang et al. 2016 (J Thorac Dis)

**Citation:** Huang J, et al. "Reference values for resistance and compliance based on the single occlusion technique in healthy infants from Southeast China." J Thorac Dis. 2016;8(3):513-519.

**DOI:** [PubMed 27076948](https://pubmed.ncbi.nlm.nih.gov/27076948/)

### Sample
- **n = 205** healthy infants (112 boys, 93 girls)
- **Age range:** 1-96 weeks (median 34 weeks)
- **Weight:** 8.34 ± 2.79 kg
- **Length:** 69.95 ± 11.14 cm

### Reference Values

| Parameter | Value | Units | Notes |
|-----------|-------|-------|-------|
| **Compliance (Crs)** | 119.52 ± 60.47 | mL/kPa | Mean ± SD |
| **Resistance (Rrs)** | 5.04 (3.73-6.82) | kPa/L/s | Median (range) |

### Age-Stratified (from Proposition extraction)

| Age Group | Compliance (mL/kPa) | Resistance (kPa/L/s) |
|-----------|---------------------|----------------------|
| 1-24 weeks | ~80 | ~6 |
| 73-96 weeks | ~170 | ~4 |

### Methodology
- Single occlusion technique (SOT)
- Jaeger MasterScreen BabyBody system
- Chloral hydrate sedation (100 mg/kg)

---

## Source 2: Battisti et al. 2012 (Pediatr Therapeut)

**Citation:** Battisti O, Bertrand JM, Rouatbi H, Escandar G. "Lung Compliance and Airways Resistance in Healthy Neonates." Pediatr Therapeut. 2012;2:114.

**DOI:** 10.4172/2161-0665.1000114

### Sample
- **Control group:** n = 32 healthy neonates (195 measurements)
  - Preterm (n=23): median GA 32 wks, birthweight 1935g
  - Term (n=9): median GA 38 wks, birthweight 2985g
- **RDS group:** n = 10 (58 measurements)

### Reference Values - Healthy Neonates

| Day | Compliance (mL/cm H₂O/s) | Resistance (cm H₂O/mL/s) |
|-----|--------------------------|--------------------------|
| Day 1 | 1.37 ± 0.37 | 0.048 ± 0.17 |
| Day 3 | 1.60 ± 0.40 | 0.057 ± 0.020 |
| Day 7 | 1.67 ± 0.41 | 0.052 ± 0.012 |
| Day 14 | 1.62 ± 0.44 | 0.057 ± 0.013 |
| Day 21 | 1.56 ± 0.42 | 0.060 ± 0.015 |

### By Gestational Age

| GA | Day | Compliance (mL/cm H₂O/s) |
|----|-----|--------------------------|
| <34 weeks | Day 1 | 1.28 ± 0.40 |
| <34 weeks | Day 7 | 1.63 ± 0.46 |
| ≥34 weeks | Day 1 | 1.41 ± 0.37 |
| ≥34 weeks | Day 7 | 1.68 ± 0.39 |

### Methodology
- 2605 Infant Hugger prototype (pneumotach)
- Testing at day 1, 3, 7, 14, 21

---

## Source 3: Deranged Physiology (Summary)

**URL:** https://derangedphysiology.com/main/cicm-primary-exam/respiratory-system/Chapter-926/neonatal-respiratory-physiology

### Comparative Values (Neonate vs Adult)

| Parameter | Neonate | Adult | Units |
|-----------|---------|-------|-------|
| Tidal Volume | 6 | 6 | mL/kg |
| Total Lung Capacity | 63 | 86 | mL/kg |
| FRC | 30 | 34 | mL/kg |
| Vital Capacity | 35 | 70 | mL/kg |
| Residual Volume | 23 | 16 | mL/kg |
| Closing Capacity | 35 | 23 | mL/kg |
| Anatomical Dead Space | 3.0 | 2.2 | mL/kg |
| O₂ Consumption | 6-10 | 3 | mL/kg/min |
| Respiratory Rate | 30-50 | 12-14 | breaths/min |

### Key Finding
- Neonatal chest wall is **3× more compliant** than lungs at birth
- Higher airway resistance in neonates
- Time constant: 0.12s in healthy term infants
...
| kPa | cm H₂O | × 10.2 |
| cm H₂O | kPa | × 0.098 |
| mL/kPa | mL/cm H₂O | × 0.098 |
| kPa/L/s | cm H₂O/L/s | × 10.2 |

### Huang values converted to cm H₂O:
- Compliance: 119.52 mL/kPa ≈ **11.7 mL/cm H₂O**
- Resistance: 5.04 kPa/L/s ≈ **51.4 cm H₂O/L/s**

---

## Summary Table for MST Paper

### Infant Ventilation Reference Model

| Parameter | Value | Range | Age | Source |
|-----------|-------|-------|-----|--------|
| Compliance (Crs) | 119.52 mL/kPa | 80-170 | 1-96 wks | Huang 2016 |
...
These values define the **human reference envelope** for infant ventilation mechanics. A manikin should:
- Have adjustable compliance in range ~80-170 mL/kPa (or ~8-17 mL/cm H₂O)
- Have adjustable resistance in range ~4-6 kPa/L/s (or ~40-60 cm H₂O/L/s)
- Or at minimum, have characterized values within this range

**Gap identified:** No published data comparing manikin lung/airway mechanics to these human reference values.
